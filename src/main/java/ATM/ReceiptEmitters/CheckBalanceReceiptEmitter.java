...
public class CheckBalanceReceiptEmitter extends ReceiptEmitter {
    public CheckBalanceReceiptEmitter(String bankName, String clientName, String date, String transactionName, String accountNumber, String amount, String reference) {
